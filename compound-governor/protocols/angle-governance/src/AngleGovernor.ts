...
import {
  ...
  ProposalQueued,
  VoteCast,
} from "../../../generated/AngleGovernor/AngleGovernor";
import { AngleGovernor } from "../../../generated/AngleGovernor/AngleGovernor";
...
function getLatestProposalValues(
  ...
  if (proposal.state == ProposalState.PENDING) {
    let contract = AngleGovernor.bind(contractAddress);
